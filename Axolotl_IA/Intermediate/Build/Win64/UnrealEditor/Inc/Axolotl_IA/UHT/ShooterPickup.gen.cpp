...
AXOLOTL_IA_API UClass* Z_Construct_UClass_AShooterPickup();
...
AXOLOTL_IA_API UScriptStruct* Z_Construct_UScriptStruct_FWeaponTableRow();
...
class UScriptStruct* FWeaponTableRow::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_FWeaponTableRow.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FWeaponTableRow, (UObject*)Z_Construct_UPackage__Script_Axolotl_IA(), TEXT("WeaponTableRow"));
	}
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FWeaponTableRow::StaticStruct, Z_Construct_UScriptStruct_FWeaponTableRow_Statics::NewStructOps, TEXT("WeaponTableRow"),&Z_Registration_Info_UScriptStruct_FWeaponTableRow, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FWeaponTableRow), 2051829810U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AShooterPickup, AShooterPickup::StaticClass, TEXT("AShooterPickup"), &Z_Registration_Info_UClass_AShooterPickup, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AShooterPickup), 911880531U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_2019274560{
	TEXT("/Script/Axolotl_IA"),
	Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Usuario_Documents_Unreal_Projects_Axolotl_IA_Source_Axolotl_IA_Variant_Shooter_Weapons_ShooterPickup_h__Script_Axolotl_IA_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
